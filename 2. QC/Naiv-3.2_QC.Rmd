...
sample <- Read10X(data.dir = "/depot/tlratlif/data/LSC_scRNAseq_2023/1_CellRanger/output/Nai3_2/outs/filtered_feature_bc_matrix")
...
sample <- CreateSeuratObject(counts = sample, project = "Naiv-3.2", min.cells = 3, min.features = 200)
