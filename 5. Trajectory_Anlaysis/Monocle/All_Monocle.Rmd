---
title: "Trajectory Analysis _ All Clusters"
author: "Nikhila "
date: "`r Sys.Date()`"
output:
...
setwd("/depot/tlratlif/data/LSC_scRNAseq_2023/4_Monocle")
...
sample = readRDS(file = "/depot/tlratlif/data/LSC_scRNAseq_2023/2_Seurat/Integrate/Combined/Separate/comparison-c9-Vs-all-find-markers/integrated_second-clustering_excluding-c9/clustering-r5-pc21_SCT.rds" )
...
```{r brng_to_Monocle, warning=FALSE, message=FALSE, echo=FALSE, tidy=TRUE, eval = T, results = "hide", fig.height=8, fig.width=12}
...
### Trajectory plot:
```{r monocle_trajectory1, warning=FALSE, message=FALSE, echo=FALSE, tidy=TRUE, eval = T, results = "hide", fig.height=8, fig.width=12}
...
Boxplot shown below denotes the Seurat clusters arranged by median pseudotime. Cluster0 has lowest median pseudotime while cluster8, cluster4 and cluster9 have highest median pseudotime.  
...
```{r DE_trajectory1, warning=FALSE, message=FALSE, echo=FALSE, tidy=TRUE, eval = T, results = "hide", fig.height=8, fig.width=12}
